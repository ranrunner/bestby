...
public class ListWidget extends AppWidgetProvider {
    ...
    public void onUpdate(final Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int ins = 0; ins < appWidgetIds.length; ins++) {
            ...
            Intent intent_item = new Intent(context, WidgetService.class);
            intent_item.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetIds[ins]);
            intent_item.setData(Uri.parse(intent_item.toUri(Intent.URI_INTENT_SCHEME)));
            ...
            rv.setRemoteAdapter(appWidgetIds[ins], R.id.widget_itemslist, intent_item);
